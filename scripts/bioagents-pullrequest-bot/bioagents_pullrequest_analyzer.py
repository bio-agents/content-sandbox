...
parser = argparse.ArgumentParser(description='this script will return the bioagents difference between branches',
...
def get_changeg_bioagents(branch1, branch2, path):
    added_count = 0
    modified_count = 0
    deleted_count = 0
    format = '--name-status'
...
statistics = get_changeg_bioagents(args.branch1, args.branch2, args.path)
message = " Differences in bioagents between this PR and original bio-agents/content master branch!  \n"
message += " BioAgents affected:\n"
